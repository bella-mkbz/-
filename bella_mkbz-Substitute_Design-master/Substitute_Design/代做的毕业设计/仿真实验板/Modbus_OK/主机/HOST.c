...
uchar mtx[8],mrx[7];
uchar send101[]={0x01,0x03,0x00,0x01,0x00,0x01};
uchar revptr;
bit nodeok;
bit crcok;
uint delaycnt;
...
void main(void)
{
	uint temp16,temp16_1;
  int i;
	nodeok=0;
	asknode=0x00;
	for(i=0;i<7;i++){mrx[i]=0x00;}
	...
	{	
		...
		{				
			temp16_1=mrx[4];
			temp16_1 = (float)temp16_1/255*500;
			delaycnt=0x3ff;
			while(delaycnt--){}
			DIR=1;
